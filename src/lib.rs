...
const P503: [u64; ELEMENT_WORDS]              = [ 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xABFFFFFFFFFFFFFF, 
                                                     0x13085BDA2211E7A0, 0x1B9BF6C87B7E7DAF, 0x6045C6BDDA77A4D0, 0x004066F541811E1E ];
const P503P1: [u64; ELEMENT_WORDS]            = [ 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0xAC00000000000000,
                                                     0x13085BDA2211E7A0, 0x1B9BF6C87B7E7DAF, 0x6045C6BDDA77A4D0, 0x004066F541811E1E ];
const P503X2: [u64; ELEMENT_WORDS]            = [ 0xFFFFFFFFFFFFFFFE, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0x57FFFFFFFFFFFFFF,
                                                     0x2610B7B44423CF41, 0x3737ED90F6FCFB5E, 0xC08B8D7BB4EF49A0, 0x0080CDEA83023C3C ]; 
// Order of Alice's subgroup
const ALICE_ORDER: [u64; 4]       = [ 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0400000000000000 ]; 
// Order of Bob's subgroup
const BOB_ORDER: [u64; 4]         = [ 0xC216F6888479E82B, 0xE6FDB21EDF9F6BC4, 0x1171AF769DE93406, 0x1019BD5060478798 ];
// Alice's generator values {XPA0 + XPA1*i, XQA0, XRA0 + XRA1*i} in GF(p503^2), expressed in Montgomery representation
const A_GEN: [u64; 5*ELEMENT_WORDS]           = [ 0xE7EF4AA786D855AF, 0xED5758F03EB34D3B, 0x09AE172535A86AA9, 0x237B9CC07D622723,
...
const B_GEN: [u64; 5*ELEMENT_WORDS]           = [ 0x7EDE37F4FA0BC727, 0xF7F8EC5C8598941C, 0xD15519B516B5F5C8, 0xF6D5AC9B87A36282, 
...
const MONTGOMERY_R2: [u64; ELEMENT_WORDS]     = [ 0x5289A0CF641D011F, 0x9B88257189FED2B9, 0xA3B365D58DC8F17A, 0x5BC57AB6EFF168EC,
                                                     0x9E51998BD84D4423, 0xBF8999CBAC3B5695, 0x46E9127BCE14CDB6, 0x003F6CFCE8B81771 ];                                                   
// Value one in Montgomery representation 
const MONTGOMERY_ONE: [u64; ELEMENT_WORDS]    = [ 0x00000000000003F9, 0x0000000000000000, 0x0000000000000000, 0xB400000000000000, 
                                                     0x63CB1A6EA6DED2B4, 0x51689D8D667EB37D, 0x8ACD77C71AB24142, 0x0026FBAEC60F5953 ];     
// Value (2^256)^2 mod 3^159                                                   
const MONTGOMERY_RPRIME: [u64; 4] = [ 0x0C2615CA3C5BAA99, 0x5A4FF3072AB6AA6A, 0xA6AFD4B039AD6AA2, 0x010DA06A26DD05CB ];     
// Value -(3^159)^-1 mod 2^256 
const MONTGOMERY_rPRIME: [u64; 4] = [ 0x49C8A87190C0697D, 0x2EB7968EA0F0A558, 0x944257B696777FA2, 0xBAA4DDCD6139D2B3 ];                                                    
// Value order_Bob/3 mod p503
const BORDER_DIV3: [u64; 4]         = [ 0xEB5CFCD82C28A2B9, 0x4CFF3B5F9FDFCE96, 0xB07B3A7CDF4DBC02, 0x055DE9C5756D2D32 ];


// Fixed parameters for isogeny tree computation
const STRAT_ALICE: [u64; 124] = [ 
...
1, 1, 4, 2, 1, 1, 2, 1, 1, 8, 4, 2, 1, 1, 2, 1, 1, 4, 2, 1, 1, 2, 1, 1 ];
    ...
    fn is_digit_lessthan_ct(x: u64, y: u64) -> u64 {
        return (x ^ ((x ^ y) | ((x-y) ^ y))) >> (RADIX-1);
    }

    fn addc(carry_in: &u64, addend1: &u64, addend2: &u64, carry_out: &mut u64, sum_out: &mut u64) {
        let temp_reg = addend1 + carry_in;
        *sum_out = addend2 + temp_reg;
        *carry_out = (is_digit_lessthan_ct(temp_reg, *carry_in)) | (is_digit_lessthan_ct(*sum_out, temp_reg));
    }
